<%@ Page Title="" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="SubDepartmentAdd.aspx.cs" Inherits="CloudPro_Solution.SubDepartmentAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="container-fluid">
            ...
            <%--<tr><th>Sub-Department Master</th></tr>--%>
            <tr><td>Enter Sub-Department Name:</td><td><asp:TextBox ID="txtSubDeptName" runat="server"></asp:TextBox></td><td>Select Department</td><td>
                <asp:DropDownList ID="ddlDetp" runat="server"></asp:DropDownList></td></tr>
            <tr><td>
